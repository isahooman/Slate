            ...
            case 'reboot': {
              ...
              case 'reload': {
                ...
                for (const [key, value] of Object.entries(commandDirectories)) {
                    const commandFiles = fs.readdirSync(value).filter(file => file.endsWith('.js'));
              ...
              case 'clear': {
                const clearOption = interaction.options.getString('clear') || 'self';
                ...
                try {
                  ...
                  logger.info(`Deleted ${deleteCount} messages.`);
